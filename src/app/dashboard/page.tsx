          ...
          <div className="flex flex-col sm:flex-row gap-4 items-start sm:items-center justify-between">
            <div className="relative flex-1 max-w-md">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-gray-900 placeholder-gray-400 transition-all"
                value={searchTerm}
                          ...
                          {patient.diseases && patient.diseases.length > 0 && (
                            <div className="flex flex-wrap gap-1 mt-2">
                              {patient.diseases.map((disease, idx) => (
                                <span
                                  key={idx}
                                  className="text-xs bg-red-100 text-red-800 px-2 py-1 rounded-md"
                                >
                  ...
                  {filteredAppointments.map((appointment) => {
                    ...
                    return (
                      ...
                      >
                        <div className="flex items-center justify-between">
                          <div className="flex-1">
                            <h3 className="font-semibold text-gray-900">{appointment.diagnosis}</h3>
                            <div className="flex items-center space-x-4 mt-1 text-sm text-gray-600">
                              <span className="flex items-center space-x-1">
      ...
      {showDetailsModal && selectedAppointment && (
        <div className="fixed inset-0 z-50 bg-black bg-opacity-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-xl w-full max-w-2xl shadow-2xl relative max-h-[90vh] overflow-y-auto">
            <div className="sticky top-0 bg-gray-50 border-b border-gray-200 p-6 rounded-t-xl">
              <button
              ...
              <h2 className="text-2xl font-bold text-gray-900 pr-10">{selectedAppointment.diagnosis}</h2>
              <p className="text-sm text-gray-600 mt-1">Medical Record Details</p>
            </div>
              ...
              <div className="bg-gray-50 rounded-lg p-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-800">{selectedAppointment.patient.age} years</p>
                  </div>
                  <div>
              ...
              <div className="bg-gray-50 rounded-lg p-4">
                ...
                <div className="space-y-3">
                  <div>
                    ...
                    <p className="text-gray-800">{new Date(selectedAppointment.date).toLocaleString()}</p>
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <p className="text-gray-800">{selectedAppointment.instructions || "None provided"}</p>
                  </div>
                </div>
              </div>
              <div className="bg-gray-50 rounded-lg p-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div className="bg-white rounded-lg p-3 border border-gray-200">
                    <span className="text-xs font-medium text-gray-900 uppercase tracking-wide">Blood Pressure</span>
                  ...
                  <div className="bg-white rounded-lg p-3 border border-gray-200">
                    <span className="text-xs font-medium text-gray-900 uppercase tracking-wide">Heart Rate</span>
                  ...
                  <div className="bg-white rounded-lg p-3 border border-gray-200">
                    <span className="text-xs font-medium text-gray-900 uppercase tracking-wide">Oxygen Saturation</span>
                  ...
                  <div className="bg-white rounded-lg p-3 border border-gray-200">
                    <span className="text-xs font-medium text-gray-900 uppercase tracking-wide">Temperature</span>
                ...
                <div className="space-y-3">
                  ...
                  {selectedAppointment.aiAnalysis ? (
                    <div className="bg-white rounded-lg p-4 border border-gray-200 text-gray-800 space-y-2">
                      <div>
                        <span className="font-semibold">Summary:</span> {selectedAppointment.aiAnalysis.summary}
                      </div>
                      <div>
                      ...
                      <div>
                        <span className="font-semibold">Reason:</span> {selectedAppointment.aiAnalysis.reason}
                      </div>
                    </div>
                  ) : AIAnalysis ? (
                    <div className="bg-white rounded-lg p-4 border border-gray-200 text-gray-800 space-y-2">
                      <div>
                        <span className="font-semibold">Summary:</span> {AIAnalysis.summary}
                      </div>
                      <div>
                        <span className="font-semibold">Judgment:</span>{" "}
                        <span
                          className={`font-medium px-2 py-1 rounded-md ${
                            AIAnalysis.judgment === "Normal" ? "bg-green-100 text-green-800" : "bg-yellow-100 text-yellow-800"
                          }`}
                        >
                          {AIAnalysis.judgment}
                        </span>
                      ...
                      <div>
                        <span className="font-semibold">Reason:</span> {AIAnalysis.reason}
                      </div>
                    </div>
                  ) : (
                    <div className="bg-white rounded-lg p-4 border border-gray-200 min-h-[60px] flex items-center justify-center text-gray-600 text-sm">
          ...
          <div className="bg-white rounded-xl w-full max-w-md shadow-xl relative max-h-[90vh] overflow-y-auto">
            ...
            <form onSubmit={submitPatient} className="p-6 space-y-4">
              <div>
                ...
                <input
                  className="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500 focus:border-transparent placeholder-gray-400 text-gray-900"
              ...
              <div>
                <label className="block text-sm font-medium text-gray-900 mb-2">Diseases (Optional)</label>
                <input
                  className="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500 focus:border-transparent placeholder-gray-400 text-gray-900"
      ...
      {showAddAppointmentModal && (
        <div className="fixed inset-0 z-50 bg-black bg-opacity-50 flex items-center justify-center p-4">
          <form
            ...
            className="bg-white w-full max-w-md rounded-xl p-6 shadow-xl space-y-4"
          >
            ...
            <div>
              <label className="block text-sm font-medium text-gray-900 mb-2">Select Patient</label>
              <select
            ...
            <div>
              ...
              <textarea
                className="w-full border border-gray-300 rounded-lg px-3 py-2 resize-none focus:ring-2 focus:ring-blue-500 focus:border-transparent placeholder-gray-400 text-gray-900"
                rows={3}
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                <label className="block text-sm font-medium text-gray-900 mb-2">Temperature (°F)</label>
                <input
                  type="number"
                  step="0.1"
                  className="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500 focus:border-transparent placeholder-gray-400 text-gray-900"
              ...
              <div>
                <label className="block text-sm font-medium text-gray-900 mb-2">Heart Rate (BPM)</label>
                <input
                  type="number"
                  className="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500 focus:border-transparent placeholder-gray-400 text-gray-900"
                  placeholder="e.g., 72"
            ...
            <div>
              <label className="block text-sm font-medium text-gray-900 mb-2">Oxygen Saturation (%)</label>
              <input
                type="number"
                className="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500 focus:border-transparent placeholder-gray-400 text-gray-900"
                placeholder="e.g., 95"
            ...
            <div>
              <label className="block text-sm font-medium text-gray-900 mb-2">Blood Pressure</label>
              <input
                type="text"
                className="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500 focus:border-transparent placeholder-gray-400 text-gray-900"
            ...
            <div>
              <label className="block text-sm font-medium text-gray-900 mb-2">Instructions (Optional)</label>
              <textarea
                className="w-full border border-gray-300 rounded-lg px-3 py-2 resize-none focus:ring-2 focus:ring-blue-500 focus:border-transparent placeholder-gray-400 text-gray-900"
                rows={2}
